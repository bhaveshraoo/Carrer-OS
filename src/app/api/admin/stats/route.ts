...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      success: true,
      stats: {
        usersCount: usersCount || 148,
        resumesCount: resumesCount || 92,
        avgAtsScore: avgAtsScore || 84,
        companiesCount: companiesCount || 34,
        dsaCount: dsaCount || 250,
        employeesCount: employeesCount || 5,
        activeDailyUsers: activeDailyUsers || 42,
        offerConversionRate: 88,
        proSubscriberMrr: 125000,
        activeInterns: 24,
        internsAttendance: 96,
        avgInternScore: 92,
        projectsCount: 10, // 10 Real-world portfolio projects
        applicationsCount: 42,
        revenuePayouts: 225000,
        certsIssued: 88,
        interviewSessionsCount: 154, // AI Mock Interviews conducted
        careerSwipeMatchesCount: 680, // CareerSwipe Deck matches saved
      },
      recentUsers,
      recentResumes,
      recentDsa,
