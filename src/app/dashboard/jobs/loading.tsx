export default function JobsLoading() {
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in py-4">
      ...
      {/* Toolbar Skeleton */}
      <div className="h-14 rounded-2xl bg-muted/30 border border-border/40 animate-pulse p-3 flex items-center justify-between gap-4">
        <div className="h-8 w-64 bg-border/50 rounded-xl" />
        <div className="h-8 w-32 bg-border/50 rounded-xl" />
      </div>

      {/* Jobs Grid Skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="h-52 rounded-3xl bg-muted/30 border border-border/40 animate-pulse p-6 space-y-4 flex flex-col justify-between">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <div className="size-10 rounded-2xl bg-border/60" />
            ...
            <div className="pt-3 border-t border-border/40 flex justify-between items-center">
              ...
              <div className="h-8 w-24 bg-border/60 rounded-xl" />
            </div>
          </div>
        ))}
      </div>
